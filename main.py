...
print("==================================================")
print("Paper Trace Studio Build014 - Fold Engine Complete")
print("==================================================")
...
PEN_DXF_DIR = os.path.join(OUTPUT_DIR, "pen_dxf")
...
os.makedirs(PEN_DXF_DIR, exist_ok=True)
